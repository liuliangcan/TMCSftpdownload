...
${OBJECTDIR}/Callback_functions_curl.o: Callback_functions_curl.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Callback_functions_curl.o Callback_functions_curl.cpp

${OBJECTDIR}/DoneFiles.o: DoneFiles.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DoneFiles.o DoneFiles.cpp

${OBJECTDIR}/FTPDriver.o: FTPDriver.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FTPDriver.o FTPDriver.cpp
